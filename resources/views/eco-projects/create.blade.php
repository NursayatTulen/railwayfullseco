...
@section('title', __('New Project') . ' — EcoHub KZ')
...
<div class="form-page">
    <div class="form-page-header">
        ...
        <div>
            ...
            <p class="section-subtitle">{{ __('Enter details for the new ecological project') }}</p>
        </div>
    </div>

    <div class="card form-card">
        <form action="{{ route('eco-projects.store') }}" method="POST">
            @csrf
            <div class="form-group">
                <label class="form-label" for="title">{{ __('Project Title') }}</label>
                <input type="text" name="title" id="title" class="form-input"
                       placeholder="{{ __('Example: Aral Sea Rescue') }}" required value="{{ old('title') }}">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-input"
                          placeholder="{{ __('Detailed project information...') }}" required
...
@media (max-width:600px) {
    ...
    .form-page-header { flex-direction:row; align-items:center; }
}
</style>
@endsection
